...
```
## Wordcloud
This wordcloud was generated by using R Studio.

![image](wordcloud.png)

## Findings
Based on the wordcloud generated above, **the largest word after the word “pregnant”** was **“insulin”**.  That means, the **most frequent topic discussed** in the article was **insulin**. Insulin helps the body to manage blood sugar levels.

The **next largest word** was **“gdm”**, **“volume”** and **“increase”**.  GDM stands fo gestational diabetes mellitus. Gestational diabetes mellitus (GDM) is a condition in which a hormone made by the placenta prevents the body from using insulin effectively. 

Thus, we can conclude that blood sugar is the main factor that leads to a pregnancy complication.
